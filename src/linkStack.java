...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>dev.algorithms/src/linkStack.java at master · muyun/dev.algorithms</title>
...
<meta content="cezTe6az/E1OgpJ+Fxz3stPvzYgnBxLbXTjGLaIUJXk=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-6edea06c20f02c9c2ae32842c7455d50c08c3f69.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="113512632c1ea5fb483403c69fd73429">
        ...
        <link data-pjax-transient rel='permalink' href='/muyun/dev.algorithms/blob/3af5bb5a0ad32d373cd24644590c26f26c34535b/src/linkStack.java'>
...
<!-- blob contrib key: blob_contributors:v21:9ce4947e5c1d3b7d94f55dc572bafcbb -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:9ce4947e5c1d3b7d94f55dc572bafcbb -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/muyun/dev.algorithms/blob/master/src/linkStack.java" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
        </div>
          ...
          <form accept-charset="UTF-8" action="/muyun/dev.algorithms/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="cezTe6az/E1OgpJ+Fxz3stPvzYgnBxLbXTjGLaIUJXk=" /></div>
            ...
            <input type="hidden" name="path" id="branch" value="src/linkStack.java" />
    ...
    <div class="meta">
      <div class="info">
        ...
        <span class="mode" title="File Mode">file</span>
          <span>44 lines (28 sloc)</span>
        <span>0.958 kb</span>
      </div>
      <div class="actions">
        <div class="button-group">
                <a class="minibutton"
                   href="/muyun/dev.algorithms/edit/master/src/linkStack.java"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/muyun/dev.algorithms/raw/master/src/linkStack.java" class="button minibutton " id="raw-url">Raw</a>
            <a href="/muyun/dev.algorithms/blame/master/src/linkStack.java" class="button minibutton ">Blame</a>
          <a href="/muyun/dev.algorithms/commits/master/src/linkStack.java" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
            <a class="minibutton danger empty-icon tooltipped downwards"
               href="/muyun/dev.algorithms/delete/master/src/linkStack.java"
               title=""
...
<span id="L43" rel="#L43">43</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">// linkStack.java</span></div><div class='line' id='LC2'><span class="c1">// a stack implemented by a linked list</span></div><div class='line' id='LC3'><span class="c1">// Compared an array, the linked list is faster:</span></div><div class='line' id='LC4'><span class="c1">// i) nothing needs to be moved when an item is inserted or deleted</span></div><div class='line' id='LC5'><span class="c1">// ii) linked list uses exactly as much memory as it needs, and can expand to</span></div><div class='line' id='LC6'><span class="c1">//     fill all of the available memory while the size of an array is fixed</span></div><div class='line' id='LC7'><span class="kn">import</span> <span class="nn">java.io.*</span><span class="o">;</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="kd">class</span> <span class="nc">linkStack</span> <span class="o">{</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">private</span> <span class="n">linkList</span> <span class="n">mylist</span><span class="o">;</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="nf">linkStack</span><span class="o">(){</span>  <span class="c1">//constructor</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">mylist</span> <span class="o">=</span> <span class="k">new</span> <span class="n">linkList</span><span class="o">();</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="kt">void</span> <span class="nf">push</span><span class="o">(</span><span class="kt">int</span> <span class="n">id</span><span class="o">,</span> <span class="kt">double</span> <span class="n">dd</span><span class="o">){</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">mylist</span><span class="o">.</span><span class="na">insertFirst</span><span class="o">(</span><span class="n">id</span><span class="o">,</span> <span class="n">dd</span><span class="o">);</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="n">link</span> <span class="nf">pop</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="n">mylist</span><span class="o">.</span><span class="na">deleteFirst</span><span class="o">();</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC30'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isEmpty</span><span class="o">()</span></div><div class='line' id='LC31'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">{</span></div><div class='line' id='LC32'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="o">(</span><span class="n">mylist</span><span class="o">.</span><span class="na">isEmpty</span><span class="o">());</span></div><div class='line' id='LC33'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC36'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="kt">void</span> <span class="nf">displayStack</span><span class="o">()</span></div><div class='line' id='LC37'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">{</span></div><div class='line' id='LC38'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">print</span><span class="o">(</span><span class="s">&quot;Stack (top --&gt; bottom): &quot;</span><span class="o">);</span></div><div class='line' id='LC39'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">mylist</span><span class="o">.</span><span class="na">displayList</span><span class="o">();</span></div><div class='line' id='LC40'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC41'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC42'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC43'><span class="o">}</span>  <span class="c1">// end class linkStack</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.10460s from fe17.rs.github.com">GitHub</span>, Inc.</li>
